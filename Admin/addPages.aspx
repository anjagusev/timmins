<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminSubPage.master" AutoEventWireup="true"
    CodeFile="addPages.aspx.cs" Inherits="Admin_Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_admin_main" runat="Server">
    ...
    <br />
    <h1 style="padding-left:2em;"> <asp:Label ID="lbl_insert" runat="server" Text="Insert a new Page" /></h1>
    <table style="width:50em; margin:0 auto;" >
