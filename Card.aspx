...
<asp:Content ID="cnt_main" ContentPlaceHolderID="cph_main" runat="server">
   <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfv_name" runat="server" ControlToValidate="txt_name" Text="*Required*" AutoPostBack="true" ValidationGroup="email" Display="Dynamic"/>
                        <asp:CompareValidator ID="cpv_name" runat="server" ControlToValidate="txt_name" Type="String" Operator="DataTypeCheck" Text="*Invalid Name*" AutoPostBack="true" ValidationGroup="email" Display="Dynamic" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txt_sender" AutoPostBack="True" runat="server" />
                         <asp:RequiredFieldValidator ID="rfv_sender" runat="server" ControlToValidate="txt_sender"  Text="*Required*" AutoPostBack="true" ValidationGroup="email" />
            ...
            <asp:RegularExpressionValidator 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfv_patient" runat="server" ControlToValidate="txt_patient"  Text="*Required*" AutoPostBack="true" ValidationGroup="email" />
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:Panel ID="pnlCard" Style="float:left; position:relative; z-index:101; top: 15px;
                    ...
                    <asp:Image ID="img_background" runat="server"  Style="position:relative; z-index: 102; height: 400px;
                        width: 368px;" /><br />
                    &nbsp;
                    <div id="mail_header">
        ...
        <asp:Button ID="btn_email" runat="server" CausesValidation="true" ValidationGroup="email" Text="Send Email" OnClick="subClick" />
</asp:Content>
