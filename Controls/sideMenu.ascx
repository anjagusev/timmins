...
<asp:Menu ID="sideMenu" Orientation="Vertical" runat="server" DataSourceID="SiteMapDataSource3" CssClass="sideNav" StaticDisplayLevels="3" StaticEnableDefaultPopOutImage="false" >
