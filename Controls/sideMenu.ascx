...
<asp:Menu ID="sideMenu" Orientation="Vertical" runat="server" DataSourceID="SiteMapDataSource3" CssClass="sideNav" StaticDisplayLevels="4" StaticEnableDefaultPopOutImage="false" >
